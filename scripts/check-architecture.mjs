...
if (!currentSchemaSource.includes("STORYFORGE_DATABASE_NAME = 'storyforge-core'")
  || !currentSchemaSource.includes('STORYFORGE_SCHEMA_VERSION = 7')
  ...
  || (currentSchemaSource.match(/\.version\(/g) ?? []).length !== 7
  ...
  violations.push('[㉝B当前 schema] 必须使用 storyforge-core v7、保留 v1/v2/v3/v4/v5/v6 加表迁移、零数据改写 upgrade，并保留当前根/媒资隔离索引')
}
