    ...
    <div className="space-y-6 max-w-4xl">
      <div className="bg-bg-surface border border-border rounded-xl p-5 space-y-2">
        ...
        <FullScreenTextarea
          ...
          className="w-full h-36 p-3 bg-bg-base border border-border rounded-lg text-text-primary text-sm focus:outline-none focus:border-accent"
        />
      </div>
      ...
      <div className="bg-bg-surface border border-border rounded-xl p-5 space-y-2">
        ...
        <FullScreenTextarea
          ...
          className="w-full h-24 p-3 bg-bg-base border border-border rounded-lg text-text-primary text-sm focus:outline-none focus:border-accent"
        />
      </div>
    </div>
  )
