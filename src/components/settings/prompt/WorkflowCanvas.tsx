          ...
          {graph.nodes.map(node => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="flex touch-none cursor-grab items-center justify-between gap-2 rounded-t-[10px] border-b border-border bg-bg-elevated px-3 py-2 active:cursor-grabbing"
                  onPointerDown={event => {
