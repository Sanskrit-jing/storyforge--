            ...
            <div className="relative">
              ...
              {showRolePicker && (
                <>
                  ...
                  {/* 窄屏：贴底抽屉（全宽、可滚动）；md 起恢复原浮层定位与宽度 */}
                  <div className="fixed left-0 right-0 bottom-0 z-50 bg-bg-surface border border-border rounded-t-xl shadow-lg p-3 max-h-[70dvh] overflow-y-auto md:absolute md:left-0 md:right-auto md:bottom-auto md:top-full md:mt-1 md:rounded-lg md:max-h-none md:overflow-visible md:w-[430px]">
              ...
              <div className="relative">
                ...
                {showDimPicker && (
                  <>
                    ...
                    {/* 窄屏：贴底抽屉；md 起恢复原浮层定位与宽度 */}
                    <div className="fixed left-0 right-0 bottom-0 z-50 bg-bg-surface border border-border rounded-t-xl shadow-lg p-3 max-h-[70dvh] overflow-y-auto md:absolute md:left-0 md:right-auto md:bottom-auto md:top-full md:mt-1 md:rounded-lg md:max-h-none md:overflow-visible md:w-[420px]">
