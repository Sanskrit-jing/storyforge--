...
export const CHAT_PRIMARY = [['source', '世界引擎', 'source'], ['workbench', '制作台', 'vision'], ['library', '作品库', 'library'], ['player', '游玩', 'play']] as const;
export const chatPrimary = (id: string) => id === 'source' || id === 'library' ? id : ['play', 'memory-review', 'history'].includes(id) ? 'player' : 'workbench';
