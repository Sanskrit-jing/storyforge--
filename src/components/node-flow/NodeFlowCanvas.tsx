      ...
      >
        ...
        {props.graph.nodes.map(node => {
          ...
          return (
            ...
            >
              <header
                className="flex touch-none cursor-grab items-center justify-between gap-2 rounded-t-xl border-b border-border/70 bg-bg-elevated px-3 py-2 active:cursor-grabbing"
                onPointerDown={event => {
