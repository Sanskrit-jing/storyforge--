...
export default function WorldRulesPanel({ project }: Props) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4">
      ...
      {/* 三列布局：宽屏三栏并排；窄屏纵向堆叠（两级导航各成一行横向滚动标签条） */}
      <div className="flex flex-col gap-0 border border-border rounded-xl overflow-y-auto bg-bg-base md:min-h-[520px] md:flex-row md:overflow-hidden">
