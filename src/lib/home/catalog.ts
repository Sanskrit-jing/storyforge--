...
export const workLabel = (w: Work) => w.kind === 'novel' ? effectiveNovelProfile(w) === 'short' ? '短篇' : '长篇' : ({screenplay:'剧本',comic:'漫画','motion-drama':'漫剧素材',avg:'AVG',ttrpg:'跑团','ai-town':'AI 小镇'}[w.kind])
