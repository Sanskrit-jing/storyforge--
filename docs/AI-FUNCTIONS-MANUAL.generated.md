...
| `knowledgeSelection` | 勾选的知识库条目 | manual | L0 | 50000 |
| `knowledgeQuery` | 知识库查询结果 | manual | L2 | 6000 |
...
| `characters` | `abilities` `activeChapterRange` `alignment` `appearance` `arc` `background` `cultivationStageId` `cultivationSystemId` `ending` `exitChapterId` `fears` `firstAppearChapterId` `firstAppearance` `goals` `habits` `homeWorldGroupId` `identity` `innerConflict` `isCrossWorld` `keyEvents` `location` `moralAxis` `motivation` `name` `orderAxis` `personality` `powerLevel` `profile` `raceEntryId` `relationships` `role` `roleWeight` `shortDescription` `signatureItem` `speechStyle` `storyRole` `strengths` `values` `voiceSamples` `weaknesses` |
...
| `chapter.content.batch` | `src/lib/ai/batch-detail-runner.ts:262` |
| `chapter.continue` | `src/lib/generation/chapter-generation-node.ts:23` |
| `chapter.deai` | `src/components/editor/ChapterEditor.tsx:885` |
| `chapter.expand` | `src/components/editor/ChapterEditor.tsx:862` |
| `chapter.memory` | `src/components/editor/ChapterEditor.tsx:593` |
| `chapter.organize` | `src/components/editor/ChapterEditor.tsx:968` |
| `chapter.polish` | `src/components/editor/ChapterEditor.tsx:851` |
| `chapter.toolbar` | `src/components/editor/FloatingToolbar.tsx:244` |
| `character.generate` | `src/components/character/CharacterPanel.tsx:160` |
| `character.rewrite` | `src/components/character/CharacterDimensionRewriteAction.tsx:109` |
| `character.structure` | `src/lib/ai/parse-character-output.ts:80` |
| `character.supplement` | `src/components/character/CharacterSupplementAction.tsx:133` |
| `character.voice-sample` | `src/components/character/VoiceSampleExtractAction.tsx:108` |
...
| `detail.scene` | `src/components/outline/DetailedOutlinePanel.tsx:151`<br/>`src/components/outline/ScenePanel.tsx:127`<br/>`src/lib/ai/batch-detail-runner.ts:110` |
...
| `location.extract` | `src/components/location/LocationPanel.tsx:113` |
| `node.creation` | `src/lib/node-flow/executor.ts:208` |
| `outline.chapter` | `src/lib/ai/batch-outline-runner.ts:123`<br/>`src/lib/outline/generation-node.ts:55` |
| `outline.character-driven` | `src/components/outline/CharacterDrivenPlotPanel.tsx:210` |
...
| `review.revise` | `src/components/editor/ChapterEditor.tsx:900` |
| `rules.generate` | `src/components/rules/CreativeRulesPanel.tsx:88` |
| `scene.verify` | `src/components/scene/SceneVerifyPanel.tsx:81` |
| `story-arc.generate` | `src/components/outline/StoryArcPanel.tsx:85` |
| `story.generate` | `src/components/worldview/StoryCorePanel.tsx:182` |
...
| `worldview.dimension` | `src/components/worldview/WorldviewHumanityPanel.tsx:334`<br/>`src/components/worldview/WorldviewNaturalPanel.tsx:284`<br/>`src/components/worldview/WorldviewOriginPanel.tsx:253` |
| `worldview.divine` | `src/components/worldview/WorldviewOriginPanel.tsx:350` |
| `worldview.divine.split` | `src/components/worldview/WorldviewOriginPanel.tsx:374` |
...
- `src/lib/ai/field-regenerate.ts:73 · chat`
- `src/lib/editor/semantic-sync.ts:230 · chat`
- `src/lib/generation/workflow-generation-node.ts:23 · ai.start`

---

生成时间基准:commit `700ecf5`
