...
左侧包括我的世界、规则与起源、自然与地理、人文与社会、人物与关系、历史与事实、故事与叙事、多世界与位面、地图、版本、数据出口、分享、社区与设置。页内左侧导航承接既有分步骤领域编辑器、字段候选与 durable Harness；故事、大纲、细纲和正文是可选语义内容，不成为所有世界的完成门槛。同一世界的叙事 Work 在故事基本信息页管理，世界名称与简介由独立 World 元数据入口修改并校验新鲜度。
